...
from astreum.storage.get.single import get_expr as _get_expr
...
def get_expr(expr_id: str, node=Depends(require_node)):
    ...
    expr: Optional[Expr] = _get_expr(node, expr_id_bytes)
    if expr is None:
